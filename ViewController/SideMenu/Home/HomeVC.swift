...
extension HomeVC : UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let reference = Storage.storage().reference(forURL: "gs://fir-chatdemo-aa2fd.appspot.com")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
     ...
     func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            let alert = UIAlertController(title: "Alert", message: "Are you sure want to Delete Chat?", preferredStyle: UIAlertController.Style.alert)
